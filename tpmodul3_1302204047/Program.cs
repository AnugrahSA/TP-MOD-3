...
namespace tpmodul3_1302204047
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Pos Kelurahan\t\t: {kelurahan11.getKodePos()}");
        }
    }
}